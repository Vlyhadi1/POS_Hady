...
class StoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'category_id' => ['required', Rule::exists('categories', 'id')->where(fn ($q) => $q->where('status', true))],
    ...
    public function messages(): array
    {
        return [
            ...
            'category_id.exists' => 'Jenis produk tidak valid atau sedang nonaktif.',
            'purchase_price.required' => 'Harga Pokok wajib diisi.',
            'purchase_price.integer' => 'Harga Pokok harus berupa angka.',
            'selling_price.required' => 'Harga jual wajib diisi.',
            'selling_price.integer' => 'Harga jual harus berupa angka.',
            'selling_price.gte' => 'Harga jual tidak boleh lebih kecil dari harga Pokok.',
